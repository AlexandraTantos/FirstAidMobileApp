...
public class BabyFeverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_baby_fever, container, false);

        stepsTextView = rootView.findViewById(R.id.text_baby_fever_steps);
    ...
    private void loadFirstAidGuide() {
        ...
        Call<FirstAidGuideViewModel> call = apiService.getFirstAidGuide(11);
