...
import com.example.firstaidapp.Adapter.GridAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            }else if(item.getItemId() == R.id.nav_find_hospital){
                Intent intent = new Intent(MainActivity.this, NearestHospitalActivity.class);
