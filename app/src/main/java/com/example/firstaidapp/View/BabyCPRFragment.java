...
public class BabyCPRFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_baby_c_p_r, container, false);

        stepsTextView = rootView.findViewById(R.id.text_baby_cpr_steps);
    ...
    private void loadFirstAidGuide() {
        ...
        Call<FirstAidGuideViewModel> call = apiService.getFirstAidGuide(9);
