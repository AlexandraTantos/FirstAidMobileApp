...
public class BurnsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        infoTextView = rootView.findViewById(R.id.text_burns_info);
        stepsTextView = rootView.findViewById(R.id.text_burns_steps);
        emergencyTextView = rootView.findViewById(R.id.text_burns_emergency);
