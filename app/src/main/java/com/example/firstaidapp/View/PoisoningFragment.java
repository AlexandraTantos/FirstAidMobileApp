...
public class PoisoningFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_poisoning, container, false);

        infoTextView = rootView.findViewById(R.id.text_poisoning_info);
        stepsTextView = rootView.findViewById(R.id.text_poisoning_steps);
