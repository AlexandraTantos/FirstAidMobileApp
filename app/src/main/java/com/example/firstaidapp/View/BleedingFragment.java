...
public class BleedingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bleeding, container, false);

        emergencyTextView = rootView.findViewById(R.id.text_bleeding_emergency);
        stepsTextView = rootView.findViewById(R.id.text_bleeding_steps);
        ...
        call.enqueue(new Callback<>() {
            ...
            public void onResponse(@NonNull Call<FirstAidGuideViewModel> call, @NonNull Response<FirstAidGuideViewModel> response) {
                if (response.isSuccessful()) {
                    ...
                    emergencyTextView.setText(guide.getText2());
