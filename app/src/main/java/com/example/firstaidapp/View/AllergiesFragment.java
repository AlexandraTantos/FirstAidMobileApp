...
public class AllergiesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        symptomsTextView = rootView.findViewById(R.id.text_allergy_info);
        stepsTextView = rootView.findViewById(R.id.text_allergy_steps);
        ...
        call.enqueue(new Callback<>() {
            ...
            public void onResponse(@NonNull Call<FirstAidGuideViewModel> call, @NonNull Response<FirstAidGuideViewModel> response) {
                if (response.isSuccessful()) {
                    ...
                    symptomsTextView.setText(guide.getText1());
