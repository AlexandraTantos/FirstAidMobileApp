...
public class BabyChokingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_baby_choking, container, false);

        stepsTextView = rootView.findViewById(R.id.text_baby_choking_steps);
    ...
    private void loadFirstAidGuide() {
        ...
        Call<FirstAidGuideViewModel> call = apiService.getFirstAidGuide(12);
