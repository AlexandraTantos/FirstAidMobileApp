...
public class ChokingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        infoTextView = rootView.findViewById(R.id.text_choking_info);
        stepsTextView = rootView.findViewById(R.id.text_choking_steps);
        emergencyTextView = rootView.findViewById(R.id.text_choking_emergency);
